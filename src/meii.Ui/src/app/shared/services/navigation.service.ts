    ...
    defaultMenu: IMenuItem[] = [
        {
            ...
            icon: 'i-Shop',
            sub: [
                { icon: 'i-Clock-3', name: 'Vendas', state: '/dashboard/v1', type: 'link' },
                { icon: 'i-Clock', name: 'Clientes', state: '/dashboard/v4', type: 'link' },
                { icon: 'i-Clock-4', name: 'Produtos', state: '/dashboard/v2', type: 'link' },
                { icon: 'i-Over-Time', name: 'Serviços', state: '/dashboard/v3', type: 'link' },
            ]
        },
        {
            name: 'Administrativo',
            ...
            icon: 'i-Bar-Chart',
            sub: [
                { icon: 'i-Clock-3', name: 'Clientes', state: '/dashboard/v1', type: 'link' },
                { icon: 'i-Clock-4', name: 'Produtos', state: '/dashboard/v2', type: 'link' },
                { icon: 'i-Over-Time', name: 'Serviços', state: '/dashboard/v3', type: 'link' },
                { icon: 'i-Clock', name: 'Empresas', state: '/dashboard/v4', type: 'link' },
            ]
        },
        {
            name: 'Dashboard',
